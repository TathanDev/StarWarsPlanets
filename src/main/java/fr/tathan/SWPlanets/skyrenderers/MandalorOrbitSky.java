...
public class MandalorOrbitSky {

    private static final ResourceLocation DIM_RENDER_INFO = new ResourceLocation(SWPlanets.MODID, "mandalore_orbit");

    @Nullable
    public static VertexBuffer starBuffer;
    private static final ResourceLocation ENDOR_TEXTURE = new ResourceLocation(SWPlanets.MODID, "textures/sky/mandalore.png");
                ...
                return new ISkyRenderHandler() {
                    ...
                    public void render(int ticks, float p_181412_, PoseStack p_181410_, ClientLevel level, Minecraft minecraft) {
                        ...
                        if (fogtype != FogType.POWDER_SNOW && fogtype != FogType.LAVA) {
                            ...
                            RenderSystem.setShaderTexture(0, ENDOR_TEXTURE);
                            bufferbuilder.begin(VertexFormat.Mode.QUADS, DefaultVertexFormat.POSITION_TEX);
