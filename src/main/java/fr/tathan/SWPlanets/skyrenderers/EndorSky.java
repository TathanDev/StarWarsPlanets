...
public class EndorSky {

    private static final ResourceLocation DIM_RENDER_INFO = new ResourceLocation(BeyondEarthMod.MODID, "endor");

    @Nullable
    public static VertexBuffer starBuffer;

    private static final ResourceLocation DEATH_STAR_TEXTURE = new ResourceLocation(SWPlanets.MODID, "textures/sky/deathstar.png");
    private static final ResourceLocation DEATH_STAR_LIGHT_TEXTURE = new ResourceLocation(BeyondEarthMod.MODID, "textures/sky/vicinus_light.png");
                ...
                return new ISkyRenderHandler() {
                    ...
                    public void render(int ticks, float p_181412_, PoseStack p_181410_, ClientLevel level, Minecraft minecraft) {
                        ...
                        if (fogtype != FogType.POWDER_SNOW && fogtype != FogType.LAVA) {
                            ...
                            /** VICINUS LIGHT */
                            RenderSystem.setShaderTexture(0, DEATH_STAR_LIGHT_TEXTURE);
                            ...
                            RenderSystem.setShaderTexture(0, DEATH_STAR_TEXTURE);
                            bufferbuilder.begin(VertexFormat.Mode.QUADS, DefaultVertexFormat.POSITION_TEX);
