...
public class SpeederGUI {
    ...
    public static class GuiContainer extends AbstractContainerMenu {
        ...
        public GuiContainer(int id, Inventory inv, FriendlyByteBuf extraData) {
            super(ScreensRegistry.SPEEDER_GUI.get(), id);

            this.speeder = inv.player.level.getEntity(extraData.readVarInt());

            IItemHandlerModifiable itemHandler = ((SpeederEntity) speeder).getItemHandler();
