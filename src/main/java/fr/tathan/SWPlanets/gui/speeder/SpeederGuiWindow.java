...
@OnlyIn(Dist.CLIENT)
public class SpeederGuiWindow extends AbstractContainerScreen<SpeederGUI.GuiContainer> {

    private static final ResourceLocation texture = new ResourceLocation(BeyondEarthMod.MODID, "textures/screens/rover.png");

    public SpeederGuiWindow(SpeederGUI.GuiContainer container, Inventory inventory, Component text) {
    ...
    public void render(PoseStack ms, int mouseX, int mouseY, float partialTicks) {
        ...
        int fuel = menu.speeder.getEntityData().get(RoverEntity.FUEL);
