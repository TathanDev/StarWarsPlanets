...
public class TatooineHouses extends Structure  {


    public static final Codec<TatooineHouses> CODEC = RecordCodecBuilder.<TatooineHouses>mapCodec(instance ->
            instance.group(TatooineHouses.settingsCodec(instance),
            ...
            ).apply(instance, TatooineHouses::new)).codec();
    ...
    public TatooineHouses(Structure.StructureSettings config,
    ...
    public Optional<Structure.GenerationStub> findGenerationPoint(Structure.GenerationContext context) {
        ...
        if (!TatooineHouses.extraSpawningChecks(context)) {
    ...
    public StructureType<?> type() {
        return StructuresRegistry.TATOOINE_HOUSES.get(); // Helps the game know how to turn this structure back to json to save to chunks
    }
}
