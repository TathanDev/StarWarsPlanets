...
public class ItemsRegistry {
    ...
    public static final RegistryObject<Item> KYLO_REN_LIGHT_SABER = ITEMS.register("light_saber_kylo_ren", () -> new SithLightSaber(net.minecraft.world.item.Tiers.NETHERITE,3, -2.4F, new Item.Properties().fireResistant().stacksTo(1).tab(CreativeTabsRegistry.SWPLANETS_TAB)));
    public static final RegistryObject<Item> DARK_MAUL_LIGHT_SABER = ITEMS.register("light_saber_dark_maul", () -> new SithLightSaber(net.minecraft.world.item.Tiers.NETHERITE,3, -2.4F, new Item.Properties().fireResistant().stacksTo(1).tab(CreativeTabsRegistry.SWPLANETS_TAB)));
    public static final RegistryObject<Item> DARKSABER = ITEMS.register("darksaber", () -> new SwordItem(net.minecraft.world.item.Tiers.NETHERITE, 4, -2.5F, new Item.Properties().fireResistant().stacksTo(1).durability(4000).tab(CreativeTabsRegistry.SWPLANETS_TAB)));
